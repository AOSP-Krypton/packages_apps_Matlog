...
import com.krypton.logcat.LogcatRecordingService;
import com.krypton.logcat.data.ColorScheme;
import com.krypton.logcat.data.FilterAdapter;
import com.krypton.logcat.data.LogFileAdapter;
import com.krypton.logcat.data.LogLine;
import com.krypton.logcat.data.LogLineAdapter;
import com.krypton.logcat.data.LogLineViewHolder;
import com.krypton.logcat.data.SavedLog;
import com.krypton.logcat.data.SearchCriteria;
import com.krypton.logcat.data.SendLogDetails;
import com.krypton.logcat.data.SortedFilterArrayAdapter;
import com.krypton.logcat.db.CatlogDBHelper;
import com.krypton.logcat.db.FilterItem;
import com.krypton.logcat.helper.BuildHelper;
import com.krypton.logcat.helper.DialogHelper;
import com.krypton.logcat.helper.PreferenceHelper;
import com.krypton.logcat.helper.SaveLogHelper;
import com.krypton.logcat.helper.ServiceHelper;
import com.krypton.logcat.helper.UpdateHelper;
import com.krypton.logcat.intents.Intents;
import com.krypton.logcat.reader.LogcatReader;
import com.krypton.logcat.reader.LogcatReaderLoader;
import com.krypton.logcat.util.ArrayUtil;
import com.krypton.logcat.util.LogLineAdapterUtil;
import com.krypton.logcat.util.StringUtil;
import com.krypton.logcat.util.Util;
...
import static com.krypton.logcat.data.LogLineViewHolder.CONTEXT_MENU_CLEAR;
import static com.krypton.logcat.data.LogLineViewHolder.CONTEXT_MENU_COPY_ID;
import static com.krypton.logcat.data.LogLineViewHolder.CONTEXT_MENU_EXPAND_ALL;
import static com.krypton.logcat.data.LogLineViewHolder.CONTEXT_MENU_FILTER_ID;
...
public class LogcatActivity extends AppCompatActivity implements FilterListener, LogLineViewHolder.OnClickListener {
    ...
    public static void startChooser(Context context, String subject, String body, SendLogDetails.AttachmentType attachmentType, File attachment) {
        ...
        if (attachment != null) {
            Uri uri = FileProvider.getUriForFile(context, "com.krypton.logcat.provider", attachment);
            log.d("uri is: %s", uri);
